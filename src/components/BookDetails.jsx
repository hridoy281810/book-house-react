        ...
        <div className='my-container'>
            ...
            <div className='flex flex-col max-w-screen-lg overflow-hidden bg-white border rounded shadow-sm lg:flex-row sm:mx-auto'>
                ...
                <div className=' p-8 bg-white lg:p-16 lg:pl-10 lg:w-1/2'>
                    ...
                    {fold ? (<><p className='mb-5 text-gray-500'>{desc.substring(0, 100)}.....<span className='cursor-pointer text-blue-600' onClick={() => setFold(!fold)}>Read More</span> </p>
                    </>) : (<><p className='mb-5 text-gray-500'>{desc}.....<span className=' cursor-pointer text-blue-600' onClick={() => setFold(!fold)}>Read Less</span> </p>
                    </>)
