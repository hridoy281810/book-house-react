...
import reader from '../media/reader.json'
// // import reader from '../media/distance-education.json'
// import reader from '../media/delivery.json'
...
const Home = () => {
  ...
  if(navigation.state === 'loading'){
    ...
    return (
       ...
       {/* <LottiePlayer animationData={reader} loop={true}/> */}
       {/* <LottiePlayer /> */}
